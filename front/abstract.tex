...
Aלעתים יש בכל-זאת יש צורך לכלול פקודה הכוללת קישור פנימי או חיצוני בתוך התקציר העברי; לדוגמה: נניח שאנו משתמשים בחבילת \textenglish{\texttt{hyperref}}, אשר יוצרת קישורים פנימיים לציטוטי מקורות ביבליוגרפיים, ויש לנו צורך לצטט מקור ביבליוגרפי בתקציר העברי. במצבים כאלו חשוב לעטוף את הפקודה היוצרת את הקישור בתוך פקודת \textenglish{\texttt{\textbackslash{}textenglish\{\}}} כדי למנוע כל מיני פורענויות בלתי-רצויות. בדוגמה לעיל, נכתוב \textenglish{\texttt{\textbackslash{}textenglish\{\textbackslash{}cite\{Hoeffding\}\}}} וכך נקבל: \textenglish{\cite{Hoeffding}}.

\subsection*{\texthebrew{תת-חלק בתקציר המורחב}}

תוכן מקוצר לגבי נושא מסוים.

\subsection*{\texthebrew{תת-חלק נוסף בתקציר המורחב}}
