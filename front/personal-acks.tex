...
שים/י לב: קטע זה של תודות מודפס בפועל רק בגרסת החיבור שלאחר-הבחינה )הווה אומר רק אם הסרת את האפשרות \L{\texttt{beforeDefense}} מן האפשרויות המועברות ל-\L{\texttt{document class}} בקובץ \L{\texttt{thesis.tex}}.(
}
